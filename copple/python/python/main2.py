...
async def create_event(item: Item):
    ...
    return Response(content='{alert_message}', media_type="text/html")
    print(Table.scan)
...
async def get_all_events():
    try:
        ...
        # Convert Decimal values to float to ensure JSON serialization
        events_json = json.loads(json.dumps(events, default=float))
        return events_json
